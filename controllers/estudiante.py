...
def guardar_respuesta():
    ...
    if request.ajax:
        ...
        if respuesta:
            respuesta.update_record(respuesta=request.vars.respuesta, pregunta=request.vars.pregunta, aciertos=request.vars.aciertos, intrusiones=request.vars.intrusiones)
